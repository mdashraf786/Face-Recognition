...
class StartPage(tk.Frame):
        ...
        def __init__(self, parent, controller):
            ...
            label = tk.Label(self, text="        Welcome!        ", font=self.controller.title_font,fg="#263942")
            label.grid(row=0, sticky="ew")
            button1 = tk.Button(self, text="   New User  ", fg="#ffffff", bg="#263942",command=lambda: self.controller.show_frame("PageOne"))
            button2 = tk.Button(self, text="   Check User  ", fg="#ffffff", bg="#263942",command=lambda: self.controller.show_frame("PageTwo"))
...
class PageThree(tk.Frame):
    ...
    def trainmodel(self):
        if self.controller.num_of_images < 50:
            messagebox.showerror("ERROR", "No enough Data, Capture at least 50 images!")
            return
